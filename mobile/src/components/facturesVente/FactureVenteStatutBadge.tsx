...
import { FACTURE_STATUT_LABELS, type FactureStatut } from '../../types/factureVente'
import { STATUT_COLORS } from '../../lib/factureVenteHelpers'
...
export default function FactureVenteStatutBadge({ statut, compact, dotOnly }: Props) {
