...
const suivis_1 = __importDefault(require("./routes/suivis"));
const suivisExcel_1 = __importDefault(require("./routes/suivisExcel"));
...
app.use('/vehicules', suivis_1.default);
app.use('/vehicules', suivisExcel_1.default);
